		...
		<view class="wrapper">
			...
			<view class="input-content">
				...
				<view class="input-item">
					<input v-model="supplier_department_name"/>
				</view>
			</view>
			<view class="input-content">
				部门地址：
				<view class="input-item">
					<input v-model="supplier_department_address"/>
				</view>
			</view>
			<view class="input-content">
				管理员姓名：
				<view class="input-item">
					<input v-model="supplier_department_manage_person_name"/>
				</view>
			</view>
			<view class="input-content">
				管理员手机：
				<view class="input-item">
					<input v-model="supplier_department_manage_person_mobile"/>
				</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				supplier_department_manage_person_name:'',
				supplier_department_manage_person_mobile:'',
			}
		},
		onLoad() {
		},
