<template>
	<view class="container">
		...
		<view class="register-section">
			还没有供应商?
			<button class=".sms-btn" @click="navTo('/pages/organization/create_organization')">马上创建一个！</button>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			...mapMutations(['set_user_info', 'set_organization_info','set_join_organization']),
			...
			handle_click(item){
				this.set_join_organization(item)
				this.navTo('/pages/organization/commit_apply_for_organization')
			},
			
			search(res) {
				let myUrl = 'wx_search_organization'
